...
function usage {
        ...
        echo '   -n, --node                          Process above command with'
        echo '                                       node_exporter'
        echo '   -N [<version>]                      Force version to be used for'
        echo '                                       node_exporter'
        echo '   -b, --blackbox                      Process above command with'
        echo '                                       blackbox_exporter'
        echo '   -B [<version>]                      Force version to be used for'
        echo '                                       blackbox_exporter'
        echo '   -a, --alertmanager                  Process above command with'
        echo '                                       Alertmanager'
        echo '   -A [<version>]                      Force version to be used for'
        echo '                                       Alertmanager'
        echo '   -p, --prometheus                    Process above command with'
        echo '                                       Prometheus'
        echo '   -P [<version>]                      Force version to be used for'
        echo '                                       Prometheus'
        echo '   -c, --cgi                           Process above command with'
        echo '                                       CGI SHELL2HTTP API'
        echo '   -C [<version>]                      Force version to be used for'
        echo '                                       CGI SHELL2HTTP API'
        echo '   -m, --messaging                     Process above command with'
        echo '                                       Messaging System (PingMe CLI)'
        echo '   -M [<version>]                      Force version to be used for'
        echo '                                       Messaging System (PingMe CLI)'
